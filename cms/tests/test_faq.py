...
class FaqTest(APITestCase):
    ...
    def test_faq_model(self):
        ...
        self.assertIn('Faq', self.models_name)
    
    def test_faq_list_success(self):
        """test Faq list"""
    ...
    def test_faq_detail_success(self):
        """test Faq detail"""
        ...
        self.assertEqual(response.data.get('question'), faq.question)
        
        self.assertEqual(response.data.get('answer'), faq.answer)
